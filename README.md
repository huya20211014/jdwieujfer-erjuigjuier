...
heroku login -i
heroku container:login
heroku create ywvintk5y2m3ntl
heroku config:set ksmullive_idx=17 -a ywvintk5y2m3ntl
git add -A && git commit -m "add kszbxby17" && git push origin kszbxby17
heroku container:push web -a ywvintk5y2m3ntl && heroku container:release web -a ywvintk5y2m3ntl
...
heroku login -i
heroku container:login
heroku create njjlzjjmmjljnti
heroku config:set ksmullive_idx=18 -a njjlzjjmmjljnti
git add -A && git commit -m "add kszbxby18" && git push origin kszbxby18
heroku container:push web -a njjlzjjmmjljnti && heroku container:release web -a njjlzjjmmjljnti
    

kszbxby19


odu1ntq3ownindj@dslab2022.tk
Yttyhxways778!
...
heroku login -i
heroku container:login
heroku create odu1ntq3ownindj
heroku config:set ksmullive_idx=19 -a odu1ntq3ownindj
git add -A && git commit -m "add kszbxby19" && git push origin kszbxby19
heroku container:push web -a odu1ntq3ownindj && heroku container:release web -a odu1ntq3ownindj
    

kszbxby20


ndi4mmuwzjrjogy@dslab2022.tk
Yttyhxways778!
...
heroku login -i
heroku container:login
heroku create ndi4mmuwzjrjogy
heroku config:set ksmullive_idx=20 -a ndi4mmuwzjrjogy
git add -A && git commit -m "add kszbxby20" && git push origin kszbxby20
heroku container:push web -a ndi4mmuwzjrjogy && heroku container:release web -a ndi4mmuwzjrjogy
