...
- dymcmm01
```
dymcmm01@dslab2021.me
Yttyhxways778!

zgnhogzmyjg5y2m@dslab2021.me
Yttyhxways778!


heroku login -i
heroku container:login
heroku create zgnhogzmyjg5y2m
...
git add -A && git commit -m "add dymcmm01" && git push origin dymcmm01
heroku container:push web -a zgnhogzmyjg5y2m && heroku container:release web -a zgnhogzmyjg5y2m
```
