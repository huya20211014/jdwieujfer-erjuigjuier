# -*- coding: utf-8 -*-
# @Time    : 2021/12/29 23:56
# @Author  : muyangren907
# @Email   : myr907097904@gmail.com
# @File    : afreecatvMulLive.py
# @Software: PyCharm
# -*- coding: utf-8 -*-
        ...
        while try_time < try_max:
            try:
                ...
                _output = subprocess.check_output(
                    'bzzyjmlzgjmyrzyb -y -v verbose -rw_timeout 10000000 -loglevel error -hide_banner -analyzeduration 2147483647 -probesize 2147483647 -i "{}" -fs 1500M -t {} -bufsize 5000k -map 0 -sn -dn -c:v copy -max_muxing_queue_size 2048 "{}"'.format(
...
class AFREECATV:
    '''
        https://live-global-cdn-v02.afreecatv.com/live-stm-10
        https://live-global-cdn-v02.afreecatv.com/live-stm-12
        '''
    HOST = 'https://live-global-cdn-v02.afreecatv.com/live-stm-10'
    ...
    def get_real_url(self):
        headers = {
            ...
            'Referer': 'https://play.afreecatv.com/{}'.format(self.rid),
            'Accept-Language': 'zh-CN,zh;q=0.9,en-US;q=0.8,en;q=0.7',
        }

        params = (
            ('bjid', '{}'.format(self.rid)),
        )
        # QUALITY_WEIGHTS = {
        #     "original": 1080,
        #     "hd": 720,
        ...
        response = requests.post('https://live.afreecatv.com/afreeca/player_live_api.php', headers=headers, params=params,data=data)
        # print(response.text)
        resjson = response.json()
        AID = resjson['CHANNEL']['AID']
        play_url = '{}/auth_playlist.m3u8?aid={}'.format(self.HOST, AID)
        return play_url
