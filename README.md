...
git add -A && git commit -m "add dymcmm10" && git push origin dymcmm10
heroku container:push web -a owrmnmeyyzrhotf && heroku container:release web -a owrmnmeyyzrhotf
```
