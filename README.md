...
git add -A && git commit -m "add dymcmm04" && git push origin dymcmm04
heroku container:push web -a nwm4mzm2ntrimjk && heroku container:release web -a nwm4mzm2ntrimjk
```
